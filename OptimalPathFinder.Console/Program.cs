...
while (true)
{
    ...
    Console.WriteLine(@"Выберите опцию: " + 
        "\n" +  "0 - Выбрать маршрут с максимальной суммой приоритетов" + "\n" 
        + "1 - Выбрать маршрут охватывающий, в первую очередь наиболее приоритетные места" + "\n" + "Любое другое число - выйти" + "\n");
    ...
    try
    {
        ...
        switch (option)
        {
            ...
            case 1 : pathFinder = new MaxPriorityShowpalcesPathFinder(); break;
            default: return;
        }
