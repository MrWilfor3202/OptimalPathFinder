...
{
    //Юнит-тесты для проверки работоспособности метода поиска пути, учитывающего в первую очередь сумму приоритетов
    public class MaxSumOfPrioritesPathFinderTests
    {
        ...
        public void SetUp()
        {
            _pathFinder = new MaxSumOfPrioritiesPathFinder();
        }
